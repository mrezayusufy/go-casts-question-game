...
// methods
// save
func (r *User) Register(user entity.User) (entity.User, error) {
...
func (r *User) FindByPhoneNumber(ctx context.Context, phonenumber string) (*entity.User, error) {
...
func (d *User) IsPhoneNumberUnique(phonenumber string) (bool, error) {
	user := entity.User{}
	scanner := &userScanner{user: &user}
...
func (r *User) Get(ctx context.Context, id uint) (entity.User, error) {
